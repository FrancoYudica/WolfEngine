#pragma once
#ifndef __WOLF_BUFFER_H__
#define __WOLF_BUFFER_H__
...
namespace Rendering {
    ...
    struct BufferAttribute {
        ...
        uint32_t GetComponentCount() const
        {
            ...
            case Mat4:
                return 16;
            default:
                std::cout << "UNIMPLEMENTED_SHADER_DATA_TYPE_COMPONENT_COUNT: " << type << std::endl;
            }
            return 1;
        }
    };
    ...
    public:
        ...
        BufferLayout(std::initializer_list<BufferAttribute> attributes)
