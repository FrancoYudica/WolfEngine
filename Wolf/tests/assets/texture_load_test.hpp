#ifndef __TEXTURE_LOAD_TEST_H__
#define __TEXTURE_LOAD_TEST_H__
...
{	
	namespace Assets
	{
		...
		class TextureLoadTestLayer : public Layer
		{
			private:
			...
			public:
				void on_start()
				{
					...
					bool success;
					auto bitmap_png = Wolf::Assets::Loader::load_bitmap("test_png.png", success);
					auto bitmap_jpg = Wolf::Assets::Loader::load_bitmap("test_jpg.jpg", success);
